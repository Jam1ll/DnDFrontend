...
export const EditManualButton = ({
  ...
  const updateManual = useManual.useUpdate();
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <form onSubmit={handleSubmit} className="max-w-sm mx-auto space-y-4">
          <div className="text-white">
            <label
              htmlFor="name"
              className="flex justify-start items-center mb-2.5 text-sm tracking-wide"
            >
              NOMBRE
            </label>
            <input
          ...
          <div className="flex justify-end pt-4">
            ...
            >
              <span className="text-sm tracking-wide font-medium">
                {updateManual.isPending ? "GUARDANDO..." : "GUARDAR"}
              </span>
            </button>
          </div>
        </form>
