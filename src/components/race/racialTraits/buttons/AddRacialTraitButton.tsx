...
import { useRacialTrait } from "../../../../api/manual/race/racialTrait/racialTraitService";
import { Modal } from "../../../ui/Modal";

interface RacialTraitProps {
  manualId: string;
  raceId: string;
}

export const AddRacialTraitButton = ({
  manualId,
  raceId,
}: RacialTraitProps) => {
  const [isOpen, setIsOpen] = useState(false);

  const createRacialTrait = useRacialTrait.useCreate();
  ...
  return (
    <>
      ...
      >
        <span className="text-sm tracking-wide font-medium">NUEVO RASGO</span>
      </button>
