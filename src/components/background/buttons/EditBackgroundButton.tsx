...
} from "../../../api/manual/background/backgroundService";
import { Modal } from "../../ui/Modal";

export const EditBackgroundButton = ({
  name,
  description,
  id,
  manualId,
  ...
  const updateBackground = useBackground.useUpdate();
    ...
    updateBackground.mutate(
      {
        ...
        manualId: manualId, // Mantenemos el manual original
      },
      {
        onSuccess: () => {
          setIsOpen(false);
        ...
        <form onSubmit={handleSubmit} className="max-w-sm mx-auto space-y-4">
          <div className="text-white">
            ...
            <textarea
              ...
              placeholder="Historia del trasfondo..."
          ...
          <div className="flex justify-end pt-4">
            ...
            >
              <span className="text-sm tracking-wide font-medium">
                {updateBackground.isPending ? "GUARDANDO..." : "GUARDAR"}
              </span>
            </button>
          </div>
        </form>
